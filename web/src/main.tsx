...
const empty: Telemetry = {
  schema_version: 1, frame_id: 0, simulation_time_s: 0, mode: "waiting", fps: 0,
  deadline_missed: false, gpu_ratio: 0, sector_risk: [0, 0, 0], minimum_ttc_s: null,
  warning: "clear", latency_ms: { decode: 0, perception: 0, risk_control: 0, render: 0, total: 0 },
...
function App() {
  ...
  useEffect(() => {
    ...
    socket.onmessage = event => {
      ...
      if (next.schema_version !== 1 || next.frame_id === undefined) return;
